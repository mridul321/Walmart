...
public class Authentication extends AppCompatActivity {
    ...
    private static final String TAGE = "FACELOG";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.registerCallback(mCallbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                Log.d(TAGE, "facebook:onSuccess:" + loginResult);
                handleFacebookAccessToken(loginResult.getAccessToken());
            }

            @Override
            public void onCancel() {
                Log.d(TAGE, "facebook:onCancel");
                // ...
            }

            @Override
            public void onError(FacebookException error) {
                Log.d(TAGE, "facebook:onError", error);
                // ...
            }
        });
// ...
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.w(TAG, "signInWithCredential:failure", task.getException());                            //ERROR
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Authentication.this,"Google SignIn Failed",Toast.LENGTH_SHORT).show();
                            updateUI(null);
                        }
